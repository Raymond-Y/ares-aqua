...
class BaseProcessing:
    ...
    def __init__(self):
        ...
        self.setup_beacons()
        self.writeFile = open('resultsBeacon.csv','w')
                ...
                if len(output_converted) > 1:
                    ...
                    if(len(outputs) == 2):
                        ...
                        if(node =='0'):
                            ...
                            result_rssi = ("iBeaconA," + position + (" RSSI=\"%s\" " %rssi_db) + strtime + '\n')
                            ...
                            result_rssi = ("iBeaconB," + position + (" RSSI=\"%s\" " %rssi_db) + strtime + '\n')
                            BaseProcessing.writeFile.write(result_rssi)
                        elif(node =='2'):
                            ...
                            result_rssi = ("iBeaconC," + position + (" RSSI=\"%s\" " %rssi_db) + strtime + '\n')
                            BaseProcessing.writeFile.write(result_rssi)
                        elif(node =='3'):
                            ...
                            result_rssi = ("iBeaconD," + position + (" RSSI=\"%s\" " %rssi_db) + strtime + '\n')
                            BaseProcessing.writeFile.write(result_rssi)
                        elif(node =='4'):
                            ...
                            result_rssi = ("iBeaconE," + position + (" RSSI=\"%s\" " %rssi_db) + strtime + '\n')
                            BaseProcessing.writeFile.write(result_rssi)
                        elif(node =='5'):
                            ...
                            result_rssi = ("iBeaconF," + position + (" RSSI=\"%s\" " %rssi_db) + strtime + '\n')
                            BaseProcessing.writeFile.write(result_rssi)
                        elif(node =='6'):
                            ...
                            result_rssi = ("iBeaconG," + position + (" RSSI=\"%s\" " %rssi_db) + strtime + '\n')
                            BaseProcessing.writeFile.write(result_rssi)
                        elif(node =='7'):
                            ...
                            result_rssi = ("iBeaconH," + position + (" RSSI=\"%s\" " %rssi_db) + strtime + '\n')
                            BaseProcessing.writeFile.write(result_rssi)
                        elif(node =='8'):
                            ...
                            result_rssi = ("iBeaconI," + position + (" RSSI=\"%s\" " %rssi_db) + strtime + '\n')
                            BaseProcessing.writeFile.write(result_rssi)
                        elif(node =='9'):
                            ...
                            result_rssi = ("iBeaconJ," + position + (" RSSI=\"%s\" " %rssi_db) + strtime + '\n')
                            BaseProcessing.writeFile.write(result_rssi)
                        elif(node =='10'):
                            ...
                            result_rssi = ("iBeaconK," + position + (" RSSI=\"%s\" " %rssi_db) + strtime + '\n')
                            BaseProcessing.writeFile.write(result_rssi)
                        elif(node =='11'):
                            ...
                            result_rssi = ("iBeaconL," + position + (" RSSI=\"%s\" " %rssi_db) + strtime + '\n')
                            BaseProcessing.writeFile.write(result_rssi)
                        BaseProcessing.lock_data.release()
