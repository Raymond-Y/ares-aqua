...
// #include "ble_mobile_static.h" TODO: FIX
...
K_THREAD_DEFINE(imu_rw, THREAD_IMU_RW_STACK, 
                thread_imu_rw, NULL, NULL, NULL, 
                THREAD_PRIORITY_IMU, 0, 0);
